...
tjq(window).load(function() {
    ...
    if (enableChaser == 1 && tjq('#content').length > 0 && tjq('#main-menu ul.menu').length > 0) {
        ...
        tjq('<h1 class="logo navbar-brand"><a title="Travelo - home" href="http://localhost/ukk/"><img alt="" src="http://localhost/ukk/assets/dist/images/logo.png"></a></h1>').insertBefore('.chaser .menu');
